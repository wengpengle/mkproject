...
<div class="chuda_co" id="container">
  <div class="co-box">
	<div class="title"><h4>实战课程管理>>新增实战课程</h4></div>
<div class="fill-info">
    <div class="right">
        <a class="btn02" id="xg_btn" href="javascript:;">实战课程列表</a>
    <div class="info-box">
        <form action="{{url('admin/add_actual')}}" method="post" enctype="multipart/form-data">
            <table>
                <tr>
                    <td><label>实战课程名称：</label></td>
                    <td><input type="text" name="act_name" class="w200 name" value=""></td>
                </tr>
                <tr>
                    <td> <label>实战课程介绍：</label></td>
                    <td><textarea name="act_desc" id="" cols="30" rows="10"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>  <input type="text" name="act_price" class="w200 name" value=""></td>
                </tr>
                <tr>
                    <td><label>课程学习所需时间：</label></td>
                    <td> <input type="text" name="study_time" class="w200 name" value=""></td>
                </tr>
                <tr>
